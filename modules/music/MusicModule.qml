...
FocusScope {
  ...
  Keys.onPressed: event => {
    ...
    case Qt.Key_Space:
    case Qt.Key_K:
      Music.active.canTogglePlaying ? Music.active.togglePlaying() : null
      break

    // Next/Previous track with `N` and `P`
    case Qt.Key_P:
      Music.active.canGoPrevious ? Music.active.previous() : null
      break

    case Qt.Key_N:
      Music.active.canGoNext ? Music.active.next() : null
      break

    // Move in song advancement with `H` and `L`
    case Qt.Key_L:
      Music.active.seek(10)
      break
    ...
    ColumnLayout {
            ...
            RowLayout {
              ...
              Rectangle {
                ...
                ColumnLayout {
                  ...
                  // Title
                  Text {
                    text: Music.active.trackTitle || "Unknown title"
                  ...
                  // Artist
                  Text {
                    text: Music.active.trackArtist || "Unknown artist"
                    color: Config.md3.on_background
                    font.family: Config.fontFamily
          ...
          Rectangle {
            ...
            RowLayout {
              ...
              Rectangle {
                ...
                MouseArea {
                  anchors.fill: parent
                  onClicked: Music.active.canGoPrevious ? Music.active.previous() : null
                }
      ...
      Rectangle {
        ...
        Rectangle {
          ...
          Rectangle {
            width: (Music.songPercentage / 100) * parent.width
            height: parent.height
            color: Config.md3.primary
            radius: height / 2
          ...
          Rectangle {
            width: parent.width - ((Music.songPercentage / 100) * parent.width) - 10
            height: parent.height
            anchors.right: parent.right
